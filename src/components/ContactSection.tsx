      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1">
            <h2 className="font-display text-4xl md:text-5xl text-text-main-light mb-6  font-bold">Get in Touch</h2>
            <div className="space-y-6 sm:text-lg text-gray-600 dark:text-gray-300 font-light">
              <p>India</p>
              <p>
                <a className="hover:text-primary" href="mailto:whitenoroh@gmail.com">
