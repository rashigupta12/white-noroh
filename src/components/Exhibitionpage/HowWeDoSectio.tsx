  ...
  const approaches = [
    {
      ...
      description: "Understanding of Event Management and Experiential Marketing communications as brand Investments and taking full ownership of commitment based performance on the bases of :",
    ...
    },
    {
      ...
      description: "Understanding the brand and ensuring its dignity at all levels",
      points: ["3D Rendering", "CAD Design", "Virtual Reality"]
    },
    {
      title: "Transparency",
      image: "/Exhibition/Exhibition Transparency.png",
      description: "No hidden costs ensuring the best Quality Vs. Cost equilibrium",
    ...
    },
    {
      ...
      description: "Strong Operations Dedicated sourcing ensuring best cost and flawless executions",
