      ...
      <div className="max-w-7xl mx-auto px-6 py-16 space-y-32">
        ...
        <div ref={contactRef} className="scroll-mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Reach out to us for any inquiries or consultations
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Office Location */}
            <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 border border-gray-200 dark:border-zinc-700 hover:border-primary/50 transition-all">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-gray-500 dark:text-gray-400 mt-1 shrink-0" />
            ...
            {/* Contact Information */}
            <div className="bg-linear-to-br from-primary/5 to-primary/10 rounded-xl p-6 border border-primary/20">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-gray-300 dark:border-gray-700">
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    For immediate assistance, call our dedicated support line
                    during business hours
                  </p>
                  <button
                    onClick={openServiceInquiryEmail}
